...
Applies to: investment banking, sales & trading, quantitative research, asset management, private equity, venture capital, hedge funds, corporate finance, FP&A, risk, treasury, fintech (treat as hybrid with tech).
...
4. Skills (technical: Excel, VBA, Python, Bloomberg, FactSet, Capital IQ, SQL, Tableau, Murex, Calypso, kdb+)
5. Certifications (CFA level/status, FRM, CAIA, Series 7/63/79/86/87, ACA/ACCA, CPA) — near top if already-awarded and differentiating
6. Languages (German-speaking markets especially value fluency levels: C2/C1/B2)
7. Interests (one short line — traditional in IB; recruiters do read this for "coffee chat" hooks)

## Bullet style: "deal-sheet" format

The dominant convention in IB/PE/HF resumes is listing **transactions/engagements** under the firm, not generic responsibilities.

```
Goldman Sachs, London                                    Jul 2022 – Present
Analyst, Industrials M&A

  Selected transactions:
  • €4.2B sale of [Target] to [Buyer] — built merger model, DCF, LBO;
    drafted CIM; managed 30-party process; closed Jun 2024.
  • $1.1B IPO of [Client] on NYSE — led comparable-company analysis
    and management presentation; priced at top of range.
  • Pitched 12 potential targets for [Sponsor]'s $800M buyout mandate;
    3 converted to live processes.
```

For trading roles, use **P&L / book size / Sharpe** instead of deals:
> *Ran EUR/USD options book with $80M VaR; +$14M YTD P&L, Sharpe 2.1.*

For PE/HF, include **investment thesis + outcome**:
> *Sourced & led [Company] investment ($45M check, 28% stake); grew EBITDA 3.2× over 4 years; exited via sale to [Acquirer] at 4.8× MOIC.*

For quant roles, closer to tech style but with **alpha/Sharpe/capacity** emphasis:
...
- **HF**: long/short, event-driven, activist, systematic, factor, alpha, pair trade
...
- Right-align dates; left-align roles.
...
- Long career gaps unexplained (better to own them with one line: "2023–2024: CFA Level III preparation / caregiver leave")
